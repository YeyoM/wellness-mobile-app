            ...
            <ScrollView style={{ width: '100%', minHeight: 600 }}>
              <View style={styles.exercises}>
                ...
                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'baseline', width: '100%', marginBottom: 20 }}>
                  <Text style={{ color: '#fff', fontSize: 23 }}>Number of Sets</Text>
                  <Text style={{ color: '#BDC1CA', fontSize: 13 }}>Total sets</Text>
                </View>
                <Slider
                  progress={progress_sets}
                  minimumValue={min_sets}
                  maximumValue={max_sets}
                  style={{ width: '90%', height: 20, marginBottom: 30, borderRadius: 10, alignSelf: 'center' }}
                  theme={{
                  ...
                  renderThumb={(props) => {
                    return (
                      <View style={{ width: 30, height: 30, borderRadius: 10, backgroundColor: '#157AFF', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <Text style={{ color: '#fff', fontSize: 20 }}>{sets}</Text>
                      </View>
                    )
                  }}
                  containerStyle={{
                ...
                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'baseline', width: '100%', marginBottom: 20 }}>
                  ...
                  <Text style={{ color: '#BDC1CA', fontSize: 13 }}>Total reps</Text>
                </View>
                <Slider
                  ...
                  renderThumb={(props) => {
                    return (
                      <View style={{ width: 30, height: 30, borderRadius: 10, backgroundColor: '#157AFF', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <Text style={{ color: '#fff', fontSize: 20 }}>{reps}</Text>
                      </View>
                    )
                  }}
                  containerStyle={{
                ...
                <Slider
                  ...
                  renderThumb={(props) => {
                    return (
                      <View style={{ width: 40, height: 30, borderRadius: 10, backgroundColor: '#157AFF', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <Text style={{ color: '#fff', fontSize: 20 }}>{Math.round(weight)}</Text>
                      </View>
                    )
                  }}
                  containerStyle={{
                ...
                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'baseline', width: '100%', marginBottom: 20 }}>
                  ...
                  <Text style={{ color: '#BDC1CA', fontSize: 13 }}>Minutes</Text>
                </View>
                <Slider
                  ...
                  renderThumb={(props) => {
                    return (
                      <View style={{ width: 30, height: 30, borderRadius: 10, backgroundColor: '#157AFF', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <Text style={{ color: '#fff', fontSize: 20 }}>{restTime}</Text>
                      </View>
                    )
                  }}
                  containerStyle={{
                ...
                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', width: '100%', marginBottom: 20, alignSelf: 'center', backgroundColor: '#157AFF', borderRadius: 20, padding: 10, height: 120 }}>
                  <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', width: '60%' }}>
                    <Text style={{ color: '#fff', fontSize: 18, fontWeight: 'bold' }}>Estimated calories burned</Text>
                    <Text style={{ color: '#BDC1CA', fontSize: 12 }}>This is an estimated number of the calories you’ll burn with this lift</Text>  
                  </View>
                  <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: 100, backgroundColor: '#73ADEF', borderRadius: 20 }}>
                    <Text style={{ color: '#fff', fontSize: 36, fontWeight: 'bold' }}>45</Text>
                    <Text style={{ color: '#fff', fontSize: 16, fontWeight: 'bold' }}>kcal</Text>
                  </View>
                </View>
